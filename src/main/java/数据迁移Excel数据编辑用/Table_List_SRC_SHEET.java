...
public class Table_List_SRC_SHEET {
    ...
    public static void main(String[] args) {
        ...
        for (String table : Config.tables) {
            ...
            table_list_src_line.setRUN_ID(IdHelper.idand10000(Config.Table_List_SRC_SHEET_RUNID));
            table_list_src_line.setMODULE(Config.module.toUpperCase());
            ...
            table_list_src_line.setTAB_DB_CODE("SRC_"+Config.module.toUpperCase());
            table_list_src_line.setPHASE("SRC");
            table_list_src_line.setINC_RELATED("INC_"+Config.module.toUpperCase());
